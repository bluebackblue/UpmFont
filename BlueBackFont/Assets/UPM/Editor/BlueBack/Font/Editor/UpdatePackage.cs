...
/** BlueBack.Font.Editor
*/
#if(UNITY_EDITOR)
namespace BlueBack.Font.Editor
{
	/** UpdatePackage
	*/
	public static class UpdatePackage
	{
		...
		*/
		#if(!DEF_USER_BLUEBACK_FONT)
		[UnityEditor.MenuItem("BlueBack/Font/UpdatePackage/Develop")]
		#endif
		public static void MenuItem_UpdatePackage_Develop()
		{
			UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmFont.git?path=BlueBackFont/Assets/UPM");
		}

		/** MenuItem_UpdatePackage_Last
		*/
		#if(!DEF_USER_BLUEBACK_FONT)
		[UnityEditor.MenuItem("BlueBack/Font/UpdatePackage/Last " + Version.packageversion)]
		#endif
		public static void MenuItem_UpdatePackage_Last()
		{
			string t_version = GetLastReleaseNameFromGitHub();
			if(t_version != null){
				UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmFont.git?path=BlueBackFont/Assets/UPM#" + t_version);
			}
		}
		...
		*/
		...
		{
			string t_url = "https://api.github.com/repos/bluebackblue/UpmFont/releases/latest";
